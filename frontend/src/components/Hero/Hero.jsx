...
import item1 from '../assets/banner2.jpg'
import item1_mobile from '../assets/banner_mobile.jpg'
import item3 from '../assets/Copy_of_Friday_99.webp'
const Hero = () => {
  return (
    <div className='hero'>
        <div>
            <div id="carouselExampleCaptions" className="relative" data-twe-carousel-init data-twe-ride="carousel">
                <div className="absolute bottom-0 left-0 right-0 z-[2] md:mx-[15%] mb-4 flex list-none justify-center p-0" data-twe-carousel-indicators>
                ...
                <div className="relative float-left md:-mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none" data-twe-carousel-active data-twe-carousel-item style={{ backfaceVisibility: 'hidden',}}>
      <img
        src={item1}
    ...
    <div
      className="relative float-left md:-mr-[100%] hidden w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none"
